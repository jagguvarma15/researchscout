...
from researchscout.store.models import RawItemRow, SavedPaperRow
...
def test_import_paper_lands_saves_and_converges(
    ...
    paper_id, title, already_known = import_paper(session, "local", payload)
    ...
    again_id, _, again_known = import_paper(session, "local", payload)
