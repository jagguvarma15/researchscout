...
def import_paper(session: Session, user_sub: str, payload: dict[str, Any]) -> tuple[str, str, bool]:
    ...
    the row is identical whichever path wrote it first.
    """
    ...
    return paper_id, paper.title, already_known
